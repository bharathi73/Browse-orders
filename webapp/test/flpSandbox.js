		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comtechmbrowseorders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtechmbrowseorders-display": {
								"semanticObject": "comtechmbrowseorders",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.techm.browseorders",
									"url": sap.ui.require.toUrl("com/techm/browseorders")
								}
							}
						}
					}
